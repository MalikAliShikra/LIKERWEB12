...
array(
"<3 BOT Powered By ALI SHIKRA <me> <3
🎭Site (Y) shikra1.tk 🎭",
)),
...
array(
array(
            "<3 Aρηу ηααм кα вσт ¢нĻαηу кα σя нє мαzα н3 :O Powered By <me> <3
🎭 Site (Y) shikra1.tk 🎭",
),
array(
...
array(
" <3 Jυsт ησω ωαℓα вσт ;) ρσωεяε∂ вү <3 :)
🎭 Site (Y) shikra1.tk 🎭",
)),
...
$botNormal=array(
"  <3 JUST NOW BUHAHAHA ✯✯ Powered By <me> <3
🎭 Site  shikra1.tk",
);
...
array(
"✯✯ αвнι тк єχριяє ωαĻα вσт υѕє кятα :D Powered By <me> ✯✯
🎭 Site ✯✯ shikra1.tk 🎭",
),
array(
"✯✯ Ye Mera Apna Bot  :O  ρσωєяєđ ву <me> ✯✯
🎭 Site  shikra1.tk 🎭",
),
array(
">.<  ρσωєяєđ ву <me> :O
...
$botPhoto=array(
"o.O JUST NOW GRET ρσωεяε∂ вү <me> ✯✯ Tu Bhi Laga ;)
🎭 Site  shikra1.tk 🎭",
);
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site='Site (Y) shikra1.tk
                           ║OWNER BOT║ ✯MALIK ALI SHIKRA✯
         
                            ✯✯CH TOQEER✯✯ ✯✯ATEEQ MALIK✯✯
	                                
						   ✯✯GULRAIZ REHMAN✯✯ ✯✯ISMAIL HAIDER✯✯
							     ✯✯ALI HAIDER HASHMI✯✯
